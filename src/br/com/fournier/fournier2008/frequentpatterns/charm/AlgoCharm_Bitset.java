package br.com.fournier.fournier2008.frequentpatterns.charm;
...
import br.com.fournier.ArraysAlgos;
import br.com.fournier.fournier2008.datastructures.triangularmatrix.TriangularMatrix;
import br.com.fournier.fournier2008.transaction_database_list_integers.TransactionDatabase;
import br.com.fournier.fournier2008.itemset_array_integers_with_tids_bitset.Itemset;
...
loopJ:		for(int j=i+1; j < frequentItems.size(); j++) {
	...
	void save(int[] prefix, int[] suffix, BitSetSupport tidset) throws IOException {
		...
		br.com.fournier.fournier2008.itemset_array_integers_with_count.Itemset itemset = new br.com.fournier.fournier2008.itemset_array_integers_with_count.Itemset(prefixSuffix);
